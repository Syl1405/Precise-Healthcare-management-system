...
const Preview = props => {
  ...
  return (
    ...
    <div className="oneGuy">
        <Link to={`patient/${user.userid}`}>
          <div>
            <div className="photo">
              <img src={user.imagepath} alt={user.name} />
            </div>
            <div class="condition"><img src={blood} alt="" /> <img src={blood_pressure} height="40" width="40" /></div>
            <img src={blood} height="40" width="40" />
            <img src={blood_pressure} height="40" width="40" />
            <img src={temperature} height="40" width="40" />
            <img src={activate} height="40" width="40" />
            <img src={sleep} height="40" width="40" />
          </div>
        </Link>
        <br/>
    </div>
